        ...
        <el-form style="padding-top: 20px" label-width="100px" :model="IdFormData" :rules="IdInfoRules" ref="IdFormData">
            ...
            <el-row>
              <el-col :span="9">
                <div class="grid-content">
                  <el-upload
                    ...
                    name="imgPath"
                    action="https://www.leimaominer.com/home/ueditor/imageUp"
              ...
              <el-col :span="12">
                <div class="grid-content" style="padding-left: 60px;">
                  <img class="show-img" src="../../../assets/img/IDCardFace.png" alt="样图" style="width:293px;height:190px"/>
                </div>
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item label="身份证反面">
            <el-row>
              ...
              <el-col :span="12">
                <div class="grid-content" style="padding-left: 60px;">
                  <img class="show-img" src="../../../assets/img/IDCardBack.png" alt="样图" style="width:293px;height:190px"/>
                </div>
              </el-col>
            </el-row>
          </el-form-item>
